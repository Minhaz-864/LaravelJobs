    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/apply/{{ $profile[0]->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <label for="name"
                    class="inline-block text-lg mb-2"><strong>{{ $profile[0]->name }}</strong></label>
            ...
            <div class="mb-6">
                ...
                <label for="email"
                    class="inline-block text-lg mb-2"><strong>{{ $profile[0]->email }}</strong></label>
            </div>

            <div class="mb-6">
                <label for="phone" class="inline-block text-lg mb-2">Phone</label>
                <label for="phone"
                    class="inline-block text-lg mb-2"><strong>{{ $profile[0]->phone }}</strong></label>
            ...
            <div class="mb-6">
                ...
                <label for="latest_degree"
                    class="inline-block text-lg mb-2"><strong>{{ $profile[0]->latest_degree }}</strong></label>
            ...
            <div class="mb-6">
                ...
                <label for="latest_institute"
                    class="inline-block text-lg mb-2"><strong>{{ $profile[0]->latest_institute }}</strong></label>
            ...
            <div class="mb-6">
                ...
                <label for="present_address"
                    class="inline-block text-lg mb-2"><strong>{{ $profile[0]->present_address }}</strong></label>
                ...
                <label for="cv" class="inline-block text-lg mb-2">
                    ...
                    @else
                        <a href="#" class="text-laravel"><i
                                class="fa-solid fa-file-check"></i>{{ explode('/', $profile[0]->cv)[1] }}</a>
                    @endunless
                </label>
